...
#
# Script generated by Vivado on Tue Mar 17 01:09:50 +08 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../Documents/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../Documents/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/stardust/Sharedspace/School/Term"
  fi
